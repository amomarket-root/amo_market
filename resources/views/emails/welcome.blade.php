...
<body style="margin: 0; padding: 0;">
    ...
    <div class="plain-text">
        ...
        Thank you for registering with us using your social account. We're excited to have you on board.

        You've successfully signed up using your {{ $provider }} account ({{ $user->email }}).
        You can use this same social login method to access your account in the future.
    ...
    <div class="container">
        ...
        <p>Thank you for registering with us using your social account. We're excited to have you on board.</p>

        <div class="social-login-note">
            <p><strong>You've successfully signed up using your {{ ucfirst($provider) }} account:</strong></p>
            <p><a href="mailto:{{ $user->email }}">{{ $user->email }}</a></p>
            <p>You can use this same social login method to access your account in the future.</p>
        </div>
