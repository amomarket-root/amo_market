...
const CartModal = () => {
    ...
    const [baseDeliveryCharge, setBaseDeliveryCharge] = useState(10); // Base charge per km
    ...
    }, [cartItems, deliveryCharge, platformCharge, feedingIndiaDonation, tipAmount]);
    ...
    const handleAddressSelect = async (address) => {
        ...
        try {
            // Calculate distance between user location and delivery address
            if (userLat && userLng && address.latitude && address.longitude) {
                ...
                // Calculate delivery charge (base charge * distance in km)
                const newDeliveryCharge = Math.round(baseDeliveryCharge * calculatedDistance);
    ...
    const handleOpenPaymentMethodsModel = () => {
                    ...
                    {emptyCart ? (
                        ...
                        <div>
                            ...
                            >
                                                ...
                                                <Tooltip title={selectedAddress.full_address}>
                                                    <Typography
                                                        ...
                                                        style={{
                                                            ...
                                                            maxWidth: '100%' // or set fixed width if needed
                                                        }}
                                                    >
                                ...
                                >
                                    {selectedAddress ? "Add to Payment Method" : "Please select an address"}
                                </Button>
                            </Box>
                        </div>
                    )}
