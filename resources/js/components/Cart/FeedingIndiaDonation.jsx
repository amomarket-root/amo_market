...
const FeedingIndiaDonation = ({ feedingIndiaDonation, setFeedingIndiaDonation }) => {
    return (
        <Box sx={{
            mt: 2,
            backgroundColor: '#fff',
            ...
            <Box sx={{ mr: 1, flexShrink: 0 }}>
                <Avatar
                    alt="Feeding India"
                    src="/image/feeding_india.png" // Replace with actual image path
...
export default FeedingIndiaDonation;
