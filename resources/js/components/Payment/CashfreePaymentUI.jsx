        ...
        <Box sx={{ p: 2 }}>
            ...
            {error ? (
                ...
                <>
                    ...
                    <Box sx={{ mt: 3 }}>
                        <Skeleton variant="rectangular" width="100%" height={50} sx={{ mb: 2, borderRadius: 3 }} />
                        <Skeleton variant="rectangular" width="80%" height={40} sx={{ borderRadius: 3 }} />
                        <Skeleton variant="rectangular" width="90%" height={30} sx={{ mt: 1, borderRadius: 3 }} />
                        <Skeleton variant="rectangular" width="80%" height={30} sx={{ mt: 1, borderRadius: 3 }} />
                        <Skeleton variant="rectangular" width="80%" height={30} sx={{ mt: 1, borderRadius: 3 }} />
                        <Skeleton variant="rectangular" width="80%" height={30} sx={{ mt: 1, borderRadius: 3 }} />
                    </Box>
                </>
