...
const OrderModel = ({ open, onClose }) => {
    ...
    // User Location from orderDetails
    ...
    // Initialize the map and draw the route manually
    useEffect(() => {
        if (open && mapLoaded && userLocation && shopDetails.length > 0 && mapRef.current) {
            ...
            // Create a LatLngBounds object to include all locations
            ...
            shopDetails.forEach((shop) => {
                ...
                // Add custom icon for shop location (StorefrontIcon)
                ...
                // Draw a polyline between the shop and user location
            ...
            // Add custom icon for user location (HomeIcon)
            new window.google.maps.Marker({
    ...
    }, [open, mapLoaded, userLocation, shopDetails]);
    ...
    const fetchOrderDetails = useCallback(async () => {
        ...
        try {
            ...
            console.log("order model data :", data);
            setOrderDetails(data.orderDetails);
            setShopDetails(data.shops); // Set shop details from the response
    ...
    // Fetch order details every minute
    useEffect(() => {
        if (open) {
            fetchOrderDetails(); // Fetch immediately when the dialog opens
            const interval = setInterval(fetchOrderDetails, 60000); // Refresh every 1 minute (60000 ms)

            return () => clearInterval(interval); // Cleanup interval on component unmount or when `open` changes
        }
    }, [open, fetchOrderDetails]);

    // Parse cart_items from orderDetails
                ...
                >
                    ...
                    {loading ? (
                        <Card sx={{ mb: 1, borderRadius: 2, overflow: "hidden" }}>
                            <CardContent>
                                <Skeleton variant="rectangular" width="100%" sx={{ borderRadius: 4 }} height={200} />
                            </CardContent>
                        </Card>
                        ...
                        <Card sx={{ mb: 1, borderRadius: 2, overflow: "hidden" }}>
                            <CardContent>
                                ...
                                <Typography variant="h6" gutterBottom>
                                    Your order is <span style={{ color: "#f27474", fontWeight: "bold" }}>Pending</span>, the shop will accept it soon.
                                </Typography>
                            </CardContent>
                            {/* Map Container */}
                            <div
                                ref={mapRef}
                                style={{ height: "300px", width: "100%", borderRadius: "8px", margin: "8px" }}
                            ></div>
                        </Card>
                        ...
                        <Card sx={{ mb: 1, borderRadius: 2, overflow: "hidden" }}>
                            <CardContent>
                                ...
                                <Typography variant="h6" gutterBottom>
                                    <span style={{ color: "#f27474", fontWeight: "bold" }}>{shopDetails[0]?.name}</span> Accepted your order, assigning a delivery partner soon.
                                </Typography>
                            </CardContent>
                            {/* Map Container */}
                            <div
                        ...
                        <Card sx={{ mb: 1, borderRadius: 2, overflow: "hidden" }}>
                            <CardContent>
                                ...
                                <Typography variant="h6" gutterBottom>
                                    <span style={{ color: "#f27474", fontWeight: "bold" }}>{shopDetails[0]?.name}</span> is preparing your order. Delivery partner is on the way.
                                </Typography>
                            </CardContent>
                            {/* Map Container */}
                            <div
                        ...
                        <Card sx={{ mb: 1, borderRadius: 2, overflow: "hidden" }}>
                            <CardContent>
                                <Box display="flex" alignItems="center">
                                    <img
                                        src="/image/order_on_the_way.gif"
                                        alt="Pending"
                                        style={{ width: "40px", height: "40px", marginRight: "8px" }}
                                    />
                                    <Typography
                                ...
                                <Typography variant="h6" gutterBottom>
                                    Your order is <span style={{ color: "#f27474", fontWeight: "bold" }}>On The Way</span>. Your delivery partner will arrive shortly.
                                </Typography>
                            </CardContent>
                            {/* Map Container */}
                            <div
                        ...
                        <Card sx={{ mb: 1, borderRadius: 2, overflow: "hidden" }}>
                            <CardContent>
                                ...
                                <Typography variant="h6" gutterBottom>
                                    Your order has <span style={{ color: "#f27474", fontWeight: "bold" }}>Reached</span> your location. The delivery partner will deliver it soon.
                                </Typography>
                            </CardContent>
                            {/* Map Container */}
                            <div
                                    ...
                                    <Grid item xs>
                                        ...
                                        <Box display="flex" alignItems="center" gap={1}>
                                            ...
                                            <IconButton
                                                ...
                                                sx={{ border: "1px solid", borderColor: "success" }} // Outline effect
                                            >
                                                <PhoneIcon />
                                            </IconButton>
                                        </Box>
