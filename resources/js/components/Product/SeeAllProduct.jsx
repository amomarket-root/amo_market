...
import ProductCategorySection from '../Home/ProductCategorySection';
...
const fetchProducts = async ({ queryKey }) => {
    ...
    const response = await axios.get(`${apiUrl}/portal/see_all_product`, {
        ...
        <Container sx={{
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 4 }}>
                ...
                <Typography variant="h6" fontWeight="bold" sx={{ ml: 1 }}>
                    Explore products from local shops.
                </Typography>
            </Box>
