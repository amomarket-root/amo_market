...
import { Typography, Tooltip, Card, CardContent, CardMedia, Button, IconButton } from '@mui/material';
...
const ProductCard = React.memo(({ product, theme, handleCardClick, handleAdd, handleIncrease, handleDecrease }) => {
    return (
